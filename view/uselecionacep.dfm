object FrmSelecionaCep: TFrmSelecionaCep
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Escolha um CEP abaixo'
  ClientHeight = 364
  ClientWidth = 624
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object GroupBox1: TGroupBox
      ...
      object GridSelecionaEnderecos: TDBGrid
        Left = 7
        Top = 18
        Width = 600
        Height = 272
        ...
        TitleFont.Style = []
        OnDblClick = GridSelecionaEnderecosDblClick
        Columns = <
          item
            Expanded = False
            FieldName = 'cep'
